...
export default create({
  ...
  title: 'Quanto você sabe sobre scala?',
  description: 'Teste os seus conhecimentos sobre scala',
  external: [
    'https://quizwebdev.cassiojcardoso.vercel.app/',
    'https://imersao-react-next-alura.brunnosena.vercel.app/',
    'https://python-quiz.ermessonlima.vercel.app/',
    'https://quizwebdev.cassiojcardoso.vercel.app/',
  ],
  theme: {
    colors: {
